        ...
        <div class="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
          ...
          <div class="mb-24 md:mb-0">
            <div class="rounded-lg shadow-lg h-full block bg-white">
              ...
              <div class="p-6">
                <h5 class="text-lg font-bold mb-4">Néstor Torres</h5>
                <p class="mb-6">Frontend Developer</p>
                <ul class="list-inside flex mx-auto justify-center">
                  <a id="github" href="https://github.com/0xNordian" target="_blank" class="px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 496 512"
                      class="w-4 h-4 text-blue-600"
                  ...
                  <a href="https://twitter.com/0xNordian" target="_blank" id="twitter" class="px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      class="w-4 h-4 text-blue-600"
                  ...
                  <a id="linkedin" href="https://www.linkedin.com/in/torres-nestor/" target="_blank" class="px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      class="w-4 h-4 text-blue-600"
          ...
          <div class="">
            <div class="rounded-lg shadow-lg h-full block bg-white">
              ...
              <div class="p-6">
                <h5 class="text-lg font-bold mb-4">Joey</h5>
                <p class="mb-6">Absolute Boss</p>
                <ul class="list-inside flex mx-auto justify-center">
                  <a href="#!" class="px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
