<template>
          ...
          <div class="container mx-auto xl:px-32 text-gray-800">
            <div class="grid lg:grid-cols-2 gap-12 flex items-center">
              <div class="mt-12 lg:mt-0" style="z-index: 10">
                ...
                >
                  Yesterday you <br /><span style="color: hsl(218, 81%, 75%)"
                    >said tomorrow</span
                  >
                </h1>
              ...
              <div class="mb-12 lg:mb-0 relative">
                ...
                <div
                  id="radius-shape-1"
                  class="absolute rounded-full shadow-lg blob_blur"
                ></div>
                <div
                  id="radius-shape-2"
                  class="absolute shadow-lg blob_blur"
                ></div>
                <div
                  class="block rounded-lg shadow-lg bg-glass px-6 py-12 md:px-12"
                >
                  <form>
  ...
  .blob2 {
    ...
    animation: transform2 25s ease-in-out infinite both alternate,
      movement_two 45s ease-in-out infinite both;
    transition: 15s cubic-bezier(0.07, 0.8, 0.16, 1);
  }
  ...
  @keyframes movement_two {
    ...
    50% {
      transform: translate(5%, 10%) rotate(-200deg) scale(1.2);
    }
  }
  </style>